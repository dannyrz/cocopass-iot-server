...
import com.cocopass.helper.CDB.CacheManager;
import com.cocopass.helper.CDB.DBManager;
...
public class QueryHelper {
    ...
    public static <T> T read_cache(Class<T> beanClass, String cache, Serializable key, String sql, Object...params) throws DBException {
     ...
     * @throws DBException 
     */
    public static <T> List<T> query_cache(Class<T> beanClass, String cache_region, Serializable key, String sql, Object...params) throws DBException {       
     ...
     * @throws DBException 
     */
    public static <T> List<T> query_slice_cache(Class<T> beanClass, String cache, Serializable cache_key, int cache_obj_count, String sql, int page, int count, Object...params) throws DBException {
     ...
     * @throws DBException 
     */
    public static long stat_cache(String cache_region, Serializable key, String sql, Object...params) throws DBException {
