...
//             password = pp.getProperty("password");  
            ...
            System.out.println("path:"+cp.filePath);
            cp.SetProperties();
            driver = cp.GetValue("driver");//pp.getProperty("driver");  
            url = cp.GetValue("url");//pp.getProperty("url");  
            userName = cp.GetValue("userName");//pp.getProperty("userName");  
            password = cp.GetValue("password");//pp.getProperty("password");  
            Class.forName(driver);  
        } catch (Exception e) {  
        	System.out.println("error:"+url+userName+ password);
            e.printStackTrace();  
        } finally {  
            if (fis != null)  
                try {  
